...
UPDATE food_cache
SET nutrition_details = COALESCE(nutrition_details,'{}'::jsonb) ||
    jsonb_build_object('portions', '{"piece": {"confidence": 0.95, "grams": 205.0, "label": "1 piece, cooked, excluding refuse (yield from 1 lb raw meat with refuse)", "source": "usda"}}'::jsonb)
...
UPDATE food_cache
SET nutrition_details = COALESCE(nutrition_details,'{}'::jsonb) ||
    jsonb_build_object('portions', '{"large": {"confidence": 0.95, "grams": 30.0, "label": "4 large", "source": "usda"}}'::jsonb)
...
UPDATE food_cache
SET nutrition_details = COALESCE(nutrition_details,'{}'::jsonb) ||
    jsonb_build_object('portions', '{"slice": {"confidence": 0.95, "grams": 84.0, "label": "1 slice", "source": "usda"}}'::jsonb)
...
UPDATE food_cache
SET nutrition_details = COALESCE(nutrition_details,'{}'::jsonb) ||
    jsonb_build_object('portions', '{"clove": {"confidence": 0.95, "grams": 3.0, "label": "1 clove", "source": "usda"}, "cup": {"confidence": 0.95, "grams": 136.0, "label": "1 cup", "source": "usda"}, "tsp": {"confidence": 0.95, "grams": 2.8, "label": "1 tsp", "source": "usda"}}'::jsonb)
...
UPDATE food_cache
SET nutrition_details = COALESCE(nutrition_details,'{}'::jsonb) ||
    jsonb_build_object('portions', '{"cup": {"confidence": 0.95, "grams": 47.0, "label": "1 cup shredded", "source": "usda"}, "serving": {"confidence": 0.95, "grams": 85.0, "label": "1 NLEA serving", "source": "usda"}}'::jsonb)
...
UPDATE food_cache
SET nutrition_details = COALESCE(nutrition_details,'{}'::jsonb) ||
    jsonb_build_object('portions', '{"large": {"confidence": 0.95, "grams": 840.0, "label": "1 head large (6-7\" dia.)", "source": "usda"}, "medium": {"confidence": 0.95, "grams": 588.0, "label": "1 head medium (5-6\" dia.)", "source": "usda"}, "piece": {"confidence": 0.95, "grams": 107.0, "label": "1 cup chopped (1/2\" pieces)", "source": "usda"}, "small": {"confidence": 0.95, "grams": 265.0, "label": "1 head small (4\" dia.)", "source": "usda"}}'::jsonb)
...
UPDATE food_cache
SET nutrition_details = COALESCE(nutrition_details,'{}'::jsonb) ||
    jsonb_build_object('portions', '{"cup": {"confidence": 0.95, "grams": 101.0, "label": "1 cup chopped", "source": "usda"}, "large": {"confidence": 0.95, "grams": 64.0, "label": "1 stalk, large (11\"-12\" long)", "source": "usda"}, "medium": {"confidence": 0.95, "grams": 40.0, "label": "1 stalk, medium (7-1/2\" - 8\" long)", "source": "usda"}, "serving": {"confidence": 0.95, "grams": 110.0, "label": "1 NLEA serving", "source": "usda"}, "small": {"confidence": 0.95, "grams": 17.0, "label": "1 stalk, small (5\" long)", "source": "usda"}, "tbsp": {"confidence": 0.95, "grams": 7.5, "label": "1 tbsp", "source": "usda"}}'::jsonb)
...
UPDATE food_cache
SET nutrition_details = COALESCE(nutrition_details,'{}'::jsonb) ||
    jsonb_build_object('portions', '{"cup": {"confidence": 0.95, "grams": 148.0, "label": "1 cup", "source": "usda"}}'::jsonb)
...
UPDATE food_cache
SET nutrition_details = COALESCE(nutrition_details,'{}'::jsonb) ||
    jsonb_build_object('portions', '{"cup": {"confidence": 0.95, "grams": 165.0, "label": "1 cup, chunks", "source": "usda"}, "fruit": {"confidence": 0.95, "grams": 905.0, "label": "1 fruit", "source": "usda"}, "slice": {"confidence": 0.95, "grams": 56.0, "label": "1 slice, thin (3-1/2\" dia x 1/2\" thick)", "source": "usda"}}'::jsonb)
...
UPDATE food_cache
SET nutrition_details = COALESCE(nutrition_details,'{}'::jsonb) ||
    jsonb_build_object('portions', '{"cup": {"confidence": 0.95, "grams": 114.0, "label": "0.5 cup", "source": "usda"}}'::jsonb)
WHERE food_name_normalized = 'kiwi raw' AND source = 'usda';

UPDATE food_cache
SET nutrition_details = COALESCE(nutrition_details,'{}'::jsonb) ||
    jsonb_build_object('portions', '{"cup": {"confidence": 0.95, "grams": 147.0, "label": "1 cup, chopped", "source": "usda"}}'::jsonb)
...
UPDATE food_cache
SET nutrition_details = COALESCE(nutrition_details,'{}'::jsonb) ||
    jsonb_build_object('portions', '{"large": {"confidence": 0.95, "grams": 143.0, "label": "1 large", "source": "usda"}, "medium": {"confidence": 0.95, "grams": 115.0, "label": "1 medium", "source": "usda"}, "small": {"confidence": 0.95, "grams": 62.0, "label": "1 small", "source": "usda"}}'::jsonb)
...
UPDATE food_cache
SET nutrition_details = COALESCE(nutrition_details,'{}'::jsonb) ||
    jsonb_build_object('portions', '{"cup": {"confidence": 0.95, "grams": 218.0, "label": "1 cup", "source": "usda"}, "tbsp": {"confidence": 0.95, "grams": 13.6, "label": "1 tablespoon", "source": "usda"}, "tsp": {"confidence": 0.95, "grams": 4.5, "label": "1 teaspoon", "source": "usda"}}'::jsonb)
...
UPDATE food_cache
SET nutrition_details = COALESCE(nutrition_details,'{}'::jsonb) ||
    jsonb_build_object('portions', '{"cup": {"confidence": 0.95, "grams": 218.0, "label": "1 cup", "source": "usda"}, "tbsp": {"confidence": 0.95, "grams": 13.6, "label": "1 tbsp", "source": "usda"}, "tsp": {"confidence": 0.95, "grams": 4.5, "label": "1 tsp", "source": "usda"}}'::jsonb)
...
UPDATE food_cache
SET nutrition_details = COALESCE(nutrition_details,'{}'::jsonb) ||
    jsonb_build_object('portions', '{"tbsp": {"confidence": 0.95, "grams": 7.0, "label": "1 tbsp, ground", "source": "usda"}, "tsp": {"confidence": 0.95, "grams": 2.5, "label": "1 tsp, ground", "source": "usda"}, "whole": {"confidence": 0.95, "grams": 168.0, "label": "1 cup, whole", "source": "usda"}}'::jsonb)
...
UPDATE food_cache
SET nutrition_details = COALESCE(nutrition_details,'{}'::jsonb) ||
    jsonb_build_object('portions', '{"cup": {"confidence": 0.95, "grams": 218.0, "label": "1 cup", "source": "usda"}, "tbsp": {"confidence": 0.95, "grams": 14.0, "label": "1 tbsp", "source": "usda"}, "tsp": {"confidence": 0.95, "grams": 4.5, "label": "1 tsp", "source": "usda"}}'::jsonb)
