    ...
    <div className="w-full">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
        {[
          ...
          { label: 'Entrées', value: String(entries.length), icon: <BookMarked size={16} />, gradient: 'from-rose-500 to-pink-500', glow: 'rgba(244,63,94,0.3)' },
          ...
          { label: 'Humeur', value: avgMood ? avgMood.label.split(' ')[0] : '—', icon: <TrendingUp size={16} />, gradient: 'from-fuchsia-500 to-violet-400', glow: 'rgba(217,70,239,0.3)' },
        ].map(stat => (
